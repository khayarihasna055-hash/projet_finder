    ...
    <div style={containerStyle}>
      <style>{`
        ...
        .typing{
          ...
          animation:typing 3s steps(20) forwards, blink .75s step-end infinite;
        }
              ...
              <div style={resultHeader}>
                ...
                <div style={{display:"flex",gap:"20px",alignItems:"center"}}>
                  ...
                  <div style={{textAlign:"left"}}>
                    <h2 style={{margin:0,color:"#00ffff",fontSize:"1.8rem"}}>
                      {data.name}
                    </h2>
...
function StatBox({icon,value,label}) {
  return(
    <div className="stat-card" style={statBoxStyle}>
      ...
      <div style={{fontSize:"10px",color:"#8b949e",letterSpacing:"1px"}}>
        {label}
      </div>
    </div>
  );
...
const iconBoxStyle={
  padding:"15px",
  background:"linear-gradient(45deg,#00ffff,#2563eb)",
  borderRadius:"20px",
